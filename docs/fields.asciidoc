...
--
This document describes the fields that are exported by Earthquakebeat. They are
grouped in the following categories:

* <<exported-fields-beat-common>>
* <<exported-fields-cloud>>
* <<exported-fields-docker-processor>>
* <<exported-fields-earthquakebeat>>
* <<exported-fields-ecs>>
...
Earthquake data. More: https://earthquake.usgs.gov/data/comcat/data-eventterms.php
